...
var Clues = React.createClass({displayName: "Clues",
  ...
  render: function () {    
    ...
    var backBtn = (React.createElement("button", {onClick: this.changeLocalStoragePin.bind(this, -1), className: "btn btn-default"}, "Back"));                    
    var nextBtn = (React.createElement("button", {onClick: this.changeLocalStoragePin.bind(this, 1), className: "btn btn-default"}, "Next"));
    var twoButtons = (React.createElement("div", null, React.createElement("button", {onClick: this.changeLocalStoragePin.bind(this, -1), className: "btn btn-default"}, "Back"), React.createElement("button", {onClick: this.changeLocalStoragePin.bind(this, 1), className: "btn btn-default"}, "Next")));
    var btnsToDisplay;
